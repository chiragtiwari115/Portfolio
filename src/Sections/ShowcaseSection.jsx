  ...
  return (
    <div id="work" className="app-showcase py-12 px-6">
      <div className="w-full space-y-16">
        ...
        {/* ===== FIRST PROJECT ===== */}
        <motion.div 
          className="showcaselayout flex flex-col md:flex-row items-center gap-8"
          initial="hidden"
          whileInView="visible"
        ...
        {/* ===== SECOND PROJECT ===== */}
        <motion.div 
          className="showcaselayout -mt-8 flex flex-col md:flex-row-reverse items-center gap-1"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
          variants={fadeInUp}
